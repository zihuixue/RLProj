...
--model-dir data/models/replica/audiopointgoal_depth_sample2-run2  --depth-sample 2 \
EVAL_CKPT_PATH_DIR data/models/replica/audiopointgoal_depth_sample2-run2/data/ckpt.541.pth VIDEO_OPTION [\"disk\"] \
